...
class Higienecontroller extends Controller
{
    ...
    public function listarArchivos($carpeta_id)
    {
        ...
        return view('seguridadysalud.higiene', compact('carpeta', 'archivos'));
    }
