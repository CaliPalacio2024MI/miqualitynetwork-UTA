...
class Suelocontroller extends Controller
{
    ...
    public function listarArchivos($carpeta_id)
    {
        ...
        return view('seguridadambiental.suelo', compact('carpeta', 'archivos'));
    }
