...
class Controldeairecontroller extends Controller
{
    // Vista principal de la sección "Control de Aire"
    public function controldeaire()
    {
        return view('seguridadambiental.controldeaire', [
            'propiedades' => Propiedades::all(),
            'energeticos' => Energetico::where('modulo', 'aire')->get(),
