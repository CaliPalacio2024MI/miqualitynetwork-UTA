...
class Controldeenergiacontroller extends Controller
{
    // Vista principal de la sección "Control de Energía"
    public function controldeenergia()
    {
        return view('seguridadambiental.controldeenergia', [
            'propiedades' => Propiedades::all(),
            'energeticos' => Energetico::where('modulo', 'energia')->get(),
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'energetico_id' => 'required|exists:control_energeticos_tables,id',
